...
train_data = pd.read_csv("C:/p140/PRO-C140-Project-BoilerPlate-main/static/assets/data_files/updated_product_dataset.csv")
training_sentences = []
...
model = load_model("C:/p140/PRO-C140-Project-BoilerPlate-main/static/assets/model_files/sentiment_analysis_model.h5")
